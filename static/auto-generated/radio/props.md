...
|                 |                                                                                                                                 |
| --------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| **Description** | If `true`, the user cannot interact with the radio.<br /><br />自動翻訳: `true`の場合、ユーザはラジオと対話することができない。 |
| **Attribute**   | `disabled`                                                                                                                      |
| **Type**        | `boolean`                                                                                                                       |
| **Default**     | `false`                                                                                                                         |
...
|                 |                                                                   |
| --------------- | ----------------------------------------------------------------- |
| **Description** | the value of the radio.<br /><br />自動翻訳: は、無線機の値です。 |
| **Attribute**   | `value`                                                           |
| **Type**        | `any`                                                             |
| **Default**     | `undefined`                                                       |
