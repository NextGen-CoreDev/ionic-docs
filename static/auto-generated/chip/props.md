...
|                 |                                                                                                                                |
| --------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| **Description** | If `true`, the user cannot interact with the chip.<br /><br />自動翻訳: `true`の場合、ユーザはチップと対話することができない。 |
| **Attribute**   | `disabled`                                                                                                                     |
| **Type**        | `boolean`                                                                                                                      |
| **Default**     | `false`                                                                                                                        |
...
|                 |                                                                                              |
| --------------- | -------------------------------------------------------------------------------------------- |
| **Description** | Display an outline style button.<br /><br />自動翻訳: アウトラインスタイルボタンを表示する。 |
| **Attribute**   | `outline`                                                                                    |
| **Type**        | `boolean`                                                                                    |
| **Default**     | `false`                                                                                      |
