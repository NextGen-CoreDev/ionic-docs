...
Using the Live Reload option will reload the browser or [Web View](/docs/guide/core-concepts/webview) when you change your app's code in your development environment. This is particularly useful for developing using hardware devices.
