...
To improve this experience, we can wrap the items in a [Grid](/docs/api/grid) component. The view can be easily rewritten into something more usable on larger screens:
...
For more information on customizing with grid, see the [Grid](/docs/api/grid) documentation.
