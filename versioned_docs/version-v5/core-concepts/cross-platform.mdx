...
To improve this experience, we can wrap the items in a [Grid](../layout/grid.mdx) component. The view can be easily rewritten into something more usable on larger screens:
...
For more information on customizing with grid, see the [Grid](../layout/grid.mdx) documentation.
