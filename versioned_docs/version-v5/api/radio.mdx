...
Radios should be used inside of an [`ion-radio-group`](radio-group.mdx). Pressing on a radio will check it. They can also be checked programmatically by setting the value property of the parent `ion-radio-group` to the value of the radio.
