...
**1) Use the [Ionic CLI](cli.mdx) to add/update/delete plugins.**
...
- `ionic doctor list`: Detects [common issues](cli/commands/doctor-list.mdx) and suggests steps to fix them
- `ionic repair`: Remove, then [regenerate](cli/commands/repair.mdx) all dependencies
