...
For virtual scrolling options in Ionic Angular, please see [Angular Virtual Scroll Guide](../angular/virtual-scroll.mdx).

## React

For virtual scrolling options in Ionic React, please see [React Virtual Scroll Guide](../react/virtual-scroll.mdx).

## Vue

For virtual scrolling options in Ionic Vue, please see [Vue Virtual Scroll Guide](../vue/virtual-scroll.mdx).
...
after scrolling. [Read more about `ion-img`.](img.mdx)
...
[`ion-img`](img.mdx) rather than the standard `<img>` HTML element.
