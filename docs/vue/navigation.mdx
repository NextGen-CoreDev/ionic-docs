...
See the [useIonRouter documentation](./utility-functions.mdx#router) for more details as well as type information.
...
▸ **useIonRouter**(): [`UseIonRouterResult`](utility-functions.mdx#useionrouterresult)
...
For example usages, please refer to our [Utility Functions](utility-functions.mdx#useionrouter).
