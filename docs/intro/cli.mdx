...
Before proceeding, make sure your computer has [Node.js](../reference/glossary.mdx#node) installed. See [these instructions](environment.mdx) to set up an environment for Ionic.
