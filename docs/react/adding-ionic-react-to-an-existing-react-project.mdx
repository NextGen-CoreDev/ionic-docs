...
For more information on routing and navigation in Ionic React, see [here](/docs/react/navigation.mdx).
...
For more info on theming your Ionic app, see the guide [here](/docs/theming/themes.mdx).
